...
public class MainCita {
    ...
    private static List<Medico> getMedicos() {
        ...
        medico1.setCorreo("dr@gmail.com");
        ...
        medico2.setCorreo("dr@gmail.com");
        ...
        medico3.setCorreo("dr@gmail.com");
    ...
    private static List<Paciente> getPacientes() {
        ...
        paciente1.setDireccion("Cristo Rey");
        paciente1.setCorreo("java@gmail.com");
        paciente1.setId(1L);
        ...
        paciente2.setDireccion("Cristo Rey");
        paciente2.setCorreo("java@gmail.com");
        paciente2.setId(2L);
        ...
        paciente3.setDireccion("Cristo Rey");
        paciente3.setCorreo("java@gmail.com");
        paciente3.setId(3L);
